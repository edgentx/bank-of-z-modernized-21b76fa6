 ...
 */
public record InputValidatedEvent(String aggregateId, Instant occurredAt, String screenId, Map<String, String> inputFields) implements DomainEvent {
  ...
  @Override public String type() { return "screen.input.validated"; }
