...
public record StatementGeneratedEvent(
    ...
    public StatementGeneratedEvent(String statementId, String accountNumber, Instant periodStart, Instant periodEnd, BigDecimal openingBalance, BigDecimal closingBalance, Instant occurredAt) {
