...
public class S18Steps {
    ...
    public void a_valid_teller_id_is_provided() {
        // Handled in the When step via direct command construction
    }
    ...
    public void the_start_session_cmd_command_is_executed() {
        StartSessionCmd cmd = new StartSessionCmd("session-1", "teller-42", "term-01");
        executeCommand(cmd);
    }
