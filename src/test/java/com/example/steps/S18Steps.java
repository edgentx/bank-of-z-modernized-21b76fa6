...
public class S18Steps {
    ...
    public void a_valid_TellerSession_aggregate() {
        ...
        aggregate.markAuthenticated(); // Pre-auth for valid state
    }
    ...
    public void a_TellerSession_aggregate_that_violates_navigation_state() {
        ...
        aggregate.markAuthenticated();
        aggregate.setActive(true); // Already active violates context
    }

    @And("a valid tellerId is provided")
    public void a_valid_tellerId_is_provided() {
        this.tellerId = "teller-007";
    }
    ...
    public void a_session_started_event_is_emitted() {
        ...
        assertEquals("teller-007", event.tellerId());
    ...
    public void the_command_is_rejected_with_a_domain_error() {
        ...
        // Domain errors are typically IllegalStateException or IllegalArgumentException in this implementation
