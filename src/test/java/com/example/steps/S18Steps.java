...
public class S18Steps {
  ...
  public void a_valid_TellerSession_aggregate() {
    ...
    aggregate.markAuthenticated(); // Simulating successful auth context
  }

  @Given("a valid tellerId is provided")
  public void a_valid_tellerId_is_provided() {
    // In a real test, we might set a field here, but we construct the Command in the When step
  }
  ...
  public void a_TellerSession_aggregate_that_violates_timeout() {
    ...
    // Set last activity to 2 hours ago (configured timeout is 30m by default)
