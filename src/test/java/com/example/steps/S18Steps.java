...
public class S18Steps {
    ...
    public void a_valid_TellerSession_aggregate() {
        ...
        aggregate.setTerminalContextReady();
    }
    ...
    public void a_TellerSession_aggregate_invalid_context() {
        ...
        aggregate.markAuthenticated();
        // Do not set terminal context
    }

    @And("a valid tellerId is provided")
    public void a_valid_tellerId_is_provided() {
        // Handled within the 'When' step construction
    }
    ...
    public void the_command_is_rejected_with_a_domain_error() {
        ...
        // We expect an IllegalStateException or IllegalArgumentException based on the invariant violated
