...
public class S18Steps {
    ...
    public void a_valid_teller_id_is_provided() {
        // Logic handled in 'When' step construction
    }
    ...
    public void the_start_session_cmd_command_is_executed() {
        try {
            // We use valid defaults for successful path, tests requiring violations set them in Given
            command = new StartSessionCmd("teller-42", "terminal-T01");
    ...
    public void the_command_is_rejected_with_a_domain_error() {
        ...
        // We expect an IllegalStateException for domain rule violations
