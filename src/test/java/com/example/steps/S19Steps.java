...
public class S19Steps {
    ...
    public void theNavigateMenuCmdCommandIsExecuted() {
        try {
            NavigateMenuCmd cmd = new NavigateMenuCmd("session-123", "ACCOUNT_DETAILS", "SELECT");
    ...
    public void aMenuNavigatedEventIsEmitted() {
        ...
        Assertions.assertEquals("ACCOUNT_DETAILS", event.getMenuId());
    }
    ...
    public void aTellerSessionAggregateThatViolatesNavState() {
        ...
        aggregate.markAuthenticated("teller-01");
        // Corrupt state: null current menu implies invalid context
        aggregate.setCurrentMenu(null); 
        aggregate.setActive(true);
    }
