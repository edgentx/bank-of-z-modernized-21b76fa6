...
public class S19Steps {
    ...
    public void a_TellerSession_aggregate_that_violates_timeout() {
        ...
        aggregate = new TellerSessionAggregate(sessionId);
        aggregate.markAuthenticated(); // Must be auth to check timeout logic usually
        aggregate.expireSession(); // Force expiry
    }

    @Given("a TellerSession aggregate that violates: Navigation state must accurately reflect the current operational context.")
    public void a_TellerSession_aggregate_that_violates_navigation_state() {
        sessionId = "SESSION-DESYNC";
        aggregate = new TellerSessionAggregate(sessionId);
        aggregate.markAuthenticated();
        aggregate.desyncNavigationState(); // Force invalid state
    }

    @And("a valid sessionId is provided")
    public void a_valid_sessionId_is_provided() {
        // Already set in aggregate construction, implicitly used in cmd
    }
