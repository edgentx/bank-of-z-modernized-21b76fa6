...
public class S19Steps {
    ...
    public void aValidTellerSessionAggregate() {
        ...
        // Setup default valid state: Authenticated
    ...
    public void aTellerSessionAggregateThatViolatesContext() {
        ...
        aggregate = new TellerSessionAggregate(sessionId);
        aggregate.markAuthenticated("teller-01");
        // We will supply invalid inputs in the 'And' step or check internal state if needed.
        // This Given sets up the aggregate object, the violation comes from invalid inputs later.
    }
    ...
    public void theCommandIsRejectedWithADomainError() {
        ...
        // Check it's an IllegalStateException (Domain Logic Violation) or IllegalArgumentException (Context Violation)
