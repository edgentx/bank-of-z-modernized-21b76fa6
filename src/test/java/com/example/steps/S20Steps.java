...
public class S20Steps {
    ...
    public void a_TellerSession_aggregate_that_violates_authentication() {
        ...
        aggregate.markUnauthenticated(); // Force state for testing
    }

    @Given("a TellerSession aggregate that violates: Sessions must timeout after a configured period of inactivity.")
    public void a_TellerSession_aggregate_that_violates_timeout() {
        aggregate = new TellerSessionAggregate("session-408");
        aggregate.markExpired(); // Force state for testing
    }

    @Given("a TellerSession aggregate that violates: Navigation state must accurately reflect the current operational context.")
    public void a_TellerSession_aggregate_that_violates_navigation_state() {
        aggregate = new TellerSessionAggregate("session-500");
        aggregate.invalidateNavigationState(); // Force state for testing
    }
