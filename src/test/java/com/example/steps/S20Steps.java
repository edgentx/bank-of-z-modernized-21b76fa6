...
public class S20Steps {
    ...
    public void aTellerSessionAggregateThatViolatesAuthentication() {
        ...
        // Intentionally not calling markAuthenticated(), leaving it as false/null equivalent
        repository.save(aggregate);
    }
    ...
    public void aTellerSessionAggregateThatViolatesTimeout() {
        ...
        aggregate.markTimedOut(); // Forces timeout logic to fail
        repository.save(aggregate);
    }
    ...
    public void aValidSessionIdIsProvided() {
        // The ID is implicit in the aggregate creation above, but we verify it exists
