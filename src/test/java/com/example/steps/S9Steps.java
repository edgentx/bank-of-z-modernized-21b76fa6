...
public class S9Steps {
    ...
    public void a_valid_statement_id_is_provided() {
        // Handled implicitly in aggregate construction or command execution context
    }
    ...
    public void a_statement_aggregate_that_violates_closed_period() {
        ...
        aggregate.setClosedPeriod(false); // Violation: Period not closed
    }

    @Given("a Statement aggregate that violates: Statement opening balance must exactly match the closing balance of the previous statement.")
    public void a_statement_aggregate_that_violates_balance_match() {
        aggregate = new StatementAggregate("stmt-violate-bal");
        aggregate.setClosedPeriod(true);
        aggregate.setOpeningBalance(BigDecimal.valueOf(50.00));
        aggregate.setPreviousClosingBalance(BigDecimal.valueOf(100.00)); // Mismatch
    }
